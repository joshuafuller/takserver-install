...
sudo sed -i '14d' /opt/tak/CoreConfig.xml
sudo sed -i '14 i \    <auth x509checkRevocation="true">' /opt/tak/CoreConfig.xml
...
sudo sed -i '82 i \            truststoreFile="certs/files/truststore-ca.DOMAIN.jks"' /opt/tak/CoreConfig.xml
